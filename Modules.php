...
<table cellspacing=0 celpadding=0 border=0 width=100%><tr><td width=60% valign=middle class='welcome'><b>Welcome to FengHua Student Information System</b></td><td width=40% class='version'>Version : ".$openSISVersion." | Release Date : ".$builddate."</td></tr></table> 
...
echo "</div>";
  ...
  <tr>
    <td align='center' class='copyright'>
       <center>copyright 2016@FengHua Training Center.
                </center></td>
  </tr>
</table>
			</td>
